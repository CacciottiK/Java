...
public class BinaryLinearSearch {
	/**
	 * Holds the 1000 element array value.
	 */
	public static int[] arrayB;	

	/**
	 * Instantiates the array to a value of 1000.
	 */
	...
	//	Scanner input = new Scanner(System.in);
		...
		while (!quit) {
			...
			System.out.println("1. Initialize and populate an array with 1000 random integers.");
			...
			try {
				...
				default:
					...
					System.out.println(); // if user fails to enter 1-5 this is shown
	...
	public void generateRandomInts() { 
		int upperBound = 1000; // holds the max generatable value by the secure random
		int lowerBound = 20; // holds lowest value generatable by secure random
