...
/**
 * This class represents a custom pane with border layout. It is used as a
 * superclass in all Lab 4 examples.
 * 
 * @version 1.19.1
 * @since JavaFX 2.0
 */
...
// leftButton.setOnAction(e -> text.setX(text.getX() - 10));
	 ...
	 * 
	 * @Override // Override the start method in the Application class public void
	 * start(Stage primaryStage) { // Create a scene and place it in the stage Scene
	 * scene = new Scene(getPane("Programming with JavaFX"), 450, 200);
