...
public class SplashScreenDemoFX extends Application {
  ...
  public void start(Stage primaryStage) {
    ...
    try {
        ...
        //If an image is in a separate folder you should use this:
        //Image splashImage = new Image(".\\image\\DukeAppSplash.gif");
    ...
    Label label = new Label("  D. Cormier's App Splash Screen Demo FX  ");
