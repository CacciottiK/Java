...
By doing that the application can be deployed both as an applet and a desktop application.
Also, by extending JPanel, the Swing GUI can be easily incorporated in a JavaFX Application (Example 5SFX - SwingJavaFX.java).
