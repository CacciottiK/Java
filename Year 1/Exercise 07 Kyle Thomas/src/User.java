...
public class User {
	...
	/*
	 * This method validates that a number input at the console is an int value, if
	 * the input is not numerical a loop will repeatedly ask for a correct numerical
	 * value.
	 */
	...
	/*
	 * This method validates that a number input at the console is a double value,
	 * if the input is not numerical a loop will repeatedly ask for a correct
	 * numerical value.
	 */
