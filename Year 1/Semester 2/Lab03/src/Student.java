...
public class Student extends Person implements Policies {
	...
	public void readInfo() {
		...
		// readMarks is placed after to initiate the acquisition of marks to calculate the GPA
		readMarks();
		// input.close();
	...
	/**
	 * Prints the info stored inside of the variables which are unique to each student
	 */
	@Override
	 ...
	 * @param deArray A Double array implemented from the policies interface. Length is based on the mark count entered for a student	 
	 */
	// sum and average were producing errors if i @param them. So i'm assuming they aren't supposed to be there
